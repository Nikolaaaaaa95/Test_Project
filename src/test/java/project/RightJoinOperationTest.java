...
public class RightJoinOperationTest {
    ...
    @Test
    public void join() {
        RightJoinOperation<DataRow<Integer, String>, DataRow<Integer, String>, JoinedDataRow> rightJoinOperation = new RightJoinOperation<>();

        assertArrayEquals(rightJoinOperation.join(countries, cities).toArray(), joinedDataRowsInner.toArray());
    }
    ...
    public void createArray() {
        ...
        joinedDataRowsInner.add(new JoinedDataRow<>(3, null, "Budapesht"));
        joinedDataRowsInner.add(new JoinedDataRow<>(5, "Portugal", "Lissabon"));
        joinedDataRowsInner.add(new JoinedDataRow<>(7, null, "Madrid"));
    }
}